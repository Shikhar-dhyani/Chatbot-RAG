...
def response_query():
    ...
    query_results = pinecone_index.query(vector=query_embedding, top_k=10)  # Increase top_k if needed
    ...
    try:
        ...
        if connection.is_connected():
            ...
            chunks = chunk_text(input_text, 1024)  # Assuming this function splits the input_text into manageable chunks
            chunk_summaries = summarize_chunks(chunks)  # Assuming this function generates a summary for each chunk
